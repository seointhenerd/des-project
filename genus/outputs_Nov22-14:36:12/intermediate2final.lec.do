...
# Generated on: Sat Nov 22 14:36:19 MST 2025 (Sat Nov 22 21:36:19 UTC 2025)
...
set logfile logs_Nov22-14:36:12/intermediate2final.lec.log ;# user can modify this name for succeeding runs
...
set_verification_information fv_map_top_pad_mv_db

read_implementation_information fv/top_pad -golden fv_map -revised top_pad_mv
...
read_design -verilog95   -golden -lastmod -noelab fv/top_pad/fv_map.v.gz
elaborate_design -golden -root {top_pad}

read_design -verilog95   -revised -lastmod -noelab outputs_Nov22-14:36:12/top_pad_m.v
elaborate_design -revised -root {top_pad}

#add_name_alias fv/top_pad/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/top_pad/top_pad_mv.singlebit.original_name.alias.json.gz -revised
...
write_compared_points noneq.compared_points.top_pad.fv_map.top_pad_mv.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.top_pad.fv_map.top_pad_mv.rpt
}
report_test_vector -noneq > noneq.test_vector.top_pad.fv_map.top_pad_mv.rpt
