...
# Generated on: Sat Nov 22 14:36:17 MST 2025 (Sat Nov 22 21:36:17 UTC 2025)
...
set logfile logs_Nov22-14:36:12/rtl2intermediate.lec.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/top_pad -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/u1425837/des-project/genus/HDL/RTL/TopModule.v /home/u1425837/des-project/genus/HDL/RTL/top_pad.v
elaborate_design -golden -root {top_pad} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/top_pad/fv_map.v.gz
...
#add_name_alias fv/top_pad/fv_map.singlebit.original_name.alias.json.gz -revised
...
add_black_box pad_in Control_State_Machine SPI pad_out -golden
...
set_system_mode lec
write_compared_points noneq.compared_points.top_pad.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.top_pad.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.top_pad.rtl.fv_map.rpt
