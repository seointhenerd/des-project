...
# Generated on: Tue Nov 04 15:56:37 MST 2025 (Tue Nov 04 22:56:37 UTC 2025)
...
set logfile logs_Nov04-15:52:07/intermediate2final.lec.log ;# user can modify this name for succeeding runs
...
set_verification_information fv_map_TopModule_mv_db

read_implementation_information fv/TopModule -golden fv_map -revised TopModule_mv
...
read_design -verilog95   -golden -lastmod -noelab fv/TopModule/fv_map.v.gz
elaborate_design -golden -root {TopModule}

read_design -verilog95   -revised -lastmod -noelab outputs_Nov04-15:52:07/TopModule_m.v
elaborate_design -revised -root {TopModule}

#add_name_alias fv/TopModule/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/TopModule/TopModule_mv.singlebit.original_name.alias.json.gz -revised
...
write_compared_points noneq.compared_points.TopModule.fv_map.TopModule_mv.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.TopModule.fv_map.TopModule_mv.rpt
}
report_test_vector -noneq > noneq.test_vector.TopModule.fv_map.TopModule_mv.rpt
